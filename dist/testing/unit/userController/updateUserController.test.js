...
describe('updateUserController', () => {
    ...
    it('should update user successfully when ID exists', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        userService_1.updateUserService.mockResolvedValueOnce({ /* mocked user data */});
        yield (0, userController_1.updateUserController)(mockRequest, mockResponse);
    ...
    it('should handle case when ID does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        userService_1.updateUserService.mockResolvedValueOnce(null);
        yield (0, userController_1.updateUserController)(mockRequest, mockResponse);
        expect(mockResponse.status).toHaveBeenCalledWith(200);
        expect(mockResponse.json).toHaveBeenCalledWith({
    ...
    it('should handle internal server error', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        userService_1.updateUserService.mockRejectedValueOnce(new Error('Internal Server Error'));
        yield (0, userController_1.updateUserController)(mockRequest, mockResponse);
